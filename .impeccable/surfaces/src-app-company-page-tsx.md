...
Earlier reference captures remain in `.impeccable/review/company/`. Previous captures and an entry-through-release recording are under `artifacts/company-sequence/`; the 1440 x 900 desktop and 1366 x 768 laptop use matching viewports for every hold and transition. Viewport captures do not scroll a locator into view, which would change the state being documented.
