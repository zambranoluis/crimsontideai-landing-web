...
**Supporting copy:** When a need requires something more specific, CrimsonTide can design and build technology around the organisation's context.
...
**Supporting copy:** Organisations that form part of CrimsonTide's experience
...
1. **Your Objective** — _Start with what you want to achieve._ We define the purpose of the solution around the outcome, improvement, or new capability you want to develop.
...
- **Title:** General Food Supermarket — Liguanea
- **Introduction:** CrimsonTide worked with General Food Supermarket in Liguanea on an AI-enabled camera technology implementation designed to support security, loss prevention, and greater visibility across operations.
- **Context:** The implementation covered operational areas of the supermarket, including cashier zones, where day-to-day activity requires a combination of security, oversight, and understanding of operational patterns.
- **Applied technology:** AI-enabled cameras and analytical capabilities were introduced to observe activity, behaviour, and patterns across the supermarket environment.
...
- **We build proprietary technology** — We develop products and technological capabilities within CrimsonTide, building knowledge and experience that can evolve with every new challenge.
- **We build around context** — When a need requires something different, we can design, adapt, or develop technology around an organisation's objectives, processes, and environment.
- **We carry ideas into use** — Our work spans from defining what is worth building to developing, integrating, and implementing solutions that can become part of real operations.
