...
try {
  if (process.argv.includes('--posters')) {
    ...
    for (const [kind, width, height] of [['globe', 1008, 900], ['terrain', 1680, 330]]) {
  ...
  for (const [name, width, height] of [['desktop', 1680, 945], ['laptop', 1280, 800], ['tablet', 768, 1024], ['mobile', 390, 844], ['phone-small', 375, 667], ['landscape', 844, 390], ['short-laptop', 1366, 768]]) {
