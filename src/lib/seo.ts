...
export const SHARE_IMAGE_ALT = "CrimsonTide — AI software company, built in Jamaica.";

export const publicRoutes = ["/", "/products", "/solutions", "/work", "/company", "/contact"] as const;
...
export const seoRecords: Record<PublicRoute, SeoRecord> = {
  "/": {
    ...
    description: "CrimsonTide is an AI software company in Jamaica developing proprietary products, AI solutions, and custom software for organisations.",
  },
  "/products": {
    title: "Conversational AI & Computer Vision Products | CrimsonTide",
    description: "Explore OpenJM conversational AI and Sentinel computer vision products, independently developed by CrimsonTide for different needs.",
  },
  "/solutions": {
    title: "AI Solutions & Custom Software Development | CrimsonTide",
    description: "CrimsonTide designs AI solutions and custom software development engagements around an organisation's objectives, context, and operations.",
  },
  "/work": {
    title: "AI Software Experience & Case Studies | CrimsonTide",
    description: "Explore CrimsonTide's AI software experience, documented case studies, sector relevance, and client relationships.",
  },
  "/company": {
    title: "Jamaica-Built AI Software Company | CrimsonTide",
    description: "Learn about CrimsonTide, a Jamaica-built AI software company developing proprietary products, AI solutions, and custom software.",
  },
  "/contact": {
    title: "AI & Custom Software Project Enquiries | CrimsonTide",
    description: "Start a conversation with CrimsonTide about an AI solution, custom software project, product, integration, or partnership.",
  },
};
