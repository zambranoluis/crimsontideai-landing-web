...
export default function SolutionsPage() { return <><SiteHeader /><main id="main-content" tabIndex={-1}>
  ...
  <section className={styles.section}><div className={styles.container}><Reveal className={styles.intro}><SectionLabel>Experience in Practice</SectionLabel><h2>Solutions built to work in real-world environments.</h2><p>Our experience includes projects where artificial intelligence and software have moved beyond the concept stage and into real operations.</p><ActionLink href="/work#work-cases">View the Liguanea case</ActionLink></Reveal></div></section>
